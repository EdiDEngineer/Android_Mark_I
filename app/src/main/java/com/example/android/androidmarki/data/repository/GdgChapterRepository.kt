...
import com.example.android.androidmarki.data.remote.network.entity.GdgResponse
import com.example.android.androidmarki.data.remote.network.entity.LatLong
import com.example.android.androidmarki.data.remote.network.service.GdgApiService
...
class GdgChapterRepository(gdgApiService: GdgApiService) {
    ...
    private suspend fun doSortData(location: Location? = null): SortedData {
        ...
        val result = coroutineScope {
            ...
            val deferred =
                async { SortedData.from(withContext(Dispatchers.IO) { request.await() }, location) }
