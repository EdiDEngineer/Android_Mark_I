...
class SleepTrackerViewModel(
    ...
    private val _navigateToSleepQuality = MutableLiveData<SleepTrackerNight>()
    /**
     ...
     */
    val navigateToSleepQuality: LiveData<SleepTrackerNight>
     ...
     *  recording.
     */
    private suspend fun getTonightFromDatabase(): SleepTrackerNight? {
    ...
    private suspend fun update(night: SleepTrackerNight) {
        withContext(Dispatchers.IO) {
            database.update(night)
        }
    }

    private suspend fun insert(night: SleepTrackerNight) {
        withContext(Dispatchers.IO) {
