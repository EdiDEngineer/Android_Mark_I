...
import com.example.android.androidmarki.databinding.GdgFinderListItemBinding
import com.example.android.androidmarki.ui.home.gdgFinder.GdgListAdapter.GdgListViewHolder
...
class GdgListAdapter(val clickListener: GdgClickListener): ListAdapter<GdgChapter, GdgListViewHolder>(
    ...
    class GdgListViewHolder(private var binding: GdgFinderListItemBinding):
        ...
        companion object {
            fun from(parent: ViewGroup): GdgListViewHolder {
                ...
                val binding = GdgFinderListItemBinding.inflate(layoutInflater, parent, false)
