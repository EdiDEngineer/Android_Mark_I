...
import com.example.android.androidmarki.receiver.AlarmReceiver
import com.example.android.androidmarki.ui.base.BaseViewModel
import com.example.android.androidmarki.util.cancelNotifications
...
class EggTimerViewModel :BaseViewModel() {
    ...
    private val alarmManager = getApplication<AndroidMarkI>().getSystemService(Context.ALARM_SERVICE) as AlarmManager
    private var prefs =
        getApplication<AndroidMarkI>().getSharedPreferences("com.example.android.androidmarki", Context.MODE_PRIVATE)
    private val notifyIntent = Intent( getApplication<AndroidMarkI>(), AlarmReceiver::class.java)
    ...
    init {
        ...
        timerLengthOptions =  getApplication<AndroidMarkI>().resources.getIntArray(R.array.minutes_array)
